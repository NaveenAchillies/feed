...
ActiveRecord::Schema.define(version: 20170915165926) do
  ...
  create_table "feed_views", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer  "user_id",    null: false
    t.integer  "post_id",    null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_feed_views_on_post_id", using: :btree
    t.index ["user_id"], name: "index_feed_views_on_user_id", using: :btree
  end
